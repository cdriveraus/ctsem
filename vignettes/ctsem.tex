...
\end{Sinput}
\begin{Soutput}
Error in `[.data.frame`(as.data.frame(datalong), c(id, manifestNames, : undefined columns selected
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
Error in as.matrix(datawide, nrow = nrow(datawide)): object 'wideexample' not found
\end{Soutput}
\end{Schunk}
...
Happiness           0.0526   -0.0726      -0.290855
