...
LeisureTime      0.9800   -0.0742
Happiness       -0.0118    0.9269
\end{Soutput}
\end{Schunk}
...
1 ctsem       <NA> 16     4191 1184 1823     NA     NA     NA
2 ctsem      ctsem 15     4197 1185 1827   5.94      1 0.0148
\end{Soutput}
\end{Schunk}
...
drift_LeisureTime_LeisureTime -0.0381  -0.0207 -0.00737     
drift_LeisureTime_Happiness   -0.1038  -0.0673 -0.03810     
drift_Happiness_LeisureTime   -0.0337  -0.0143  0.00404     
drift_Happiness_Happiness     -0.1379  -0.0764 -0.02805     
\end{Soutput}
\end{Schunk}
...
$addedTIPREDVAR
            LeisureTime Happiness
LeisureTime       2.807   -0.3840
Happiness        -0.384    0.0525
\end{Soutput}
\end{Schunk}
\vspace{\baselineskip}
\end{minipage}
...
LeisureTime      -0.008246 -0.006428      -0.006663
Happiness        -0.020276 -0.350616      -0.183562
...
R> points(density(output[1:i, 5]), col='blue', type='l', lwd=1, lty=3)
R> points(density(output[1:i, 6]), col='green', type='l', lwd=1, lty=5)
