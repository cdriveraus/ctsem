...
ctStanTIpredeffects(fit, plot = TRUE, whichpars=c('dtDRIFT[2,1]','MANIFESTMEANS'), 
...
<<echo=-1,transform, fig.width=8, fig.height=5,fig.cap="Prior distribution density plots." >>=
par(mfrow=c(1,2))
