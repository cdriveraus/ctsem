...
long<-long[1:40,]
fit<-ctStanFit(long,model,iter=500,chains=2,fit=T,plot=T,estsd=T,max_treedepth=10,adapt_delta = .8, noncentered=T,stationaryvar = F)
library(shinystan)
