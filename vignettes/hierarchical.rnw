...
ctStanPlotPost(obj = fit, rows=c(10)) 
@
...
plot=TRUE, plotcontrol=list( xaxs = "i", xlim=c(0,16), main = 'Predicted'))
 
ctKalman(fit, subjects=2, timerange=c(0,30), kalmanvec=c('y', 'ysmooth'), timestep=.01, 
plot=TRUE, plotcontrol=list( xaxs = "i", xlim=c(0,16), main = 'Smoothed'))
@
...
ctStanTIpredeffects(fit, plot = TRUE, whichpars=c('dtDRIFT','MANIFESTVAR[2,2]'), 
 timeinterval = .5, whichTIpreds = 3, includeMeanUncertainty = FALSE)
@
