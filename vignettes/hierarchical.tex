...
\hlcom{#fit}
\hlstd{fit} \hlkwb{<-} \hlkwd{ctStanFit}\hlstd{(datalong, model,} \hlkwc{iter}\hlstd{=}\hlnum{200}\hlstd{,} \hlkwc{chains}\hlstd{=}\hlnum{2}\hlstd{)}
...
hmean_T0mean_ss_level               23.246 6.512 11.315 23.437 34.142 109.6 0.995
hmean_T0mean_ss_velocity            15.008 7.972 -1.850 15.607 29.550 121.4 0.998
hmean_ma1                            0.653 0.210  0.228  0.648  1.072  69.2 1.023
hmean_a21                           -0.355 0.048 -0.464 -0.354 -0.272  54.5 1.001
hmean_a22                           -0.330 0.109 -0.597 -0.319 -0.132  85.4 1.008
hmean_diffusion                     15.747 3.039 11.025 15.487 23.030  70.9 1.018
hmean_manifestvar_sunspots_sunspots  1.297 1.126  0.151  0.931  4.377  86.3 1.025
hmean_m1                            46.441 2.850 40.263 46.801 51.198 124.8 1.008
\end{verbatim}
\end{kframe}
\end{knitrout}
