...
\hlstd{fit} \hlkwb{<-} \hlkwd{ctStanFit}\hlstd{(datalong, model,} \hlkwc{iter}\hlstd{=}\hlnum{400}\hlstd{,} \hlkwc{chains}\hlstd{=}\hlnum{2}\hlstd{,}
  \hlkwc{stationary}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{control}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{adapt_delta}\hlstd{=}\hlnum{.9}\hlstd{))}
...
hmean_ma1                            0.582 0.167  0.227  0.898  57.6 1.029
hmean_a21                           -0.362 0.042 -0.449 -0.284 135.3 1.004
hmean_a22                           -0.363 0.104 -0.613 -0.189 102.9 1.017
hmean_diffusion                     16.694 2.855 12.446 23.600  63.0 1.026
hmean_manifestvar_sunspots_sunspots  1.245 1.328  0.018  4.304 172.9 1.008
hmean_m1                            44.716 3.126 39.317 50.868 243.8 0.999
\end{verbatim}
\end{kframe}
\end{knitrout}
