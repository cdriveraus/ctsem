...
# has always been true, and it happened inside `.ctModelIntOverPop()` on the
...
# `.ctModelIntOverPop()` assigns states, so the two agree about which
# dimension is which.
#' @keywords internal
...
# looking at the cell: `.ctModelIntOverPop()` creates these placeholders
