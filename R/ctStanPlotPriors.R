...
#' 
#' @param ctstanmodel model object as generated by \code{\link{ctModel}} with type='stanct' or 'standt'.
...
ctStanPlotPriors<-function(ctstanmodel,rows='all',wait=FALSE,samples=1e6, hypersd='marginalise'){
  m<-ctstanmodel$parameters
  n<-5000
   highmean=1
  lowmean=-1
  ...
  for(rowi in rows){
    ...
    hypersdpriorbase<-  rnorm(samples*2)
