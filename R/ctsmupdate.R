...
continue <- readline()
if(continue){
  file.rename('./src/stan_files/ctsm.prep', './src/stan_files/ctsm.bak')
  file.rename('./src/stan_files/ctsmW32.prep', './src/stan_files/ctsmW32.bak')
sink(file='./src/stan_files/ctsm.prep')
cat(sm)
sink()
# 
