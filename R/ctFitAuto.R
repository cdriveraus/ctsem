...
#' summary(testfit)
#' }
ctFitAuto <- function(m, dat, DRIFT=TRUE, DIFFUSION=TRUE,fast=FALSE,initialRestrictions=NA, ...){
  ...
  ffinal <- ctStanFit(datalong = dat, ctstanmodel = mfinal,optimcontrol=list(estonly=fast),...)
