...
#' \code{ctStanPlotPost} is maintained as a backward-compatible alias.
#'
#' @param obj fit or model object as generated by \code{\link{ctFit}},
#' \code{\link{ctModel}}, or \code{\link{ctModelConvertOMX}}.
...
#' @param ... Parameters to pass to ctFit. \code{cores = x} will speed things up,
