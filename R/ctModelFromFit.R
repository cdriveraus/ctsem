...
#'
#' @param fit object output by \link{\code{ctFit}}
#'
#' @return object of class 'ctsemInit' (as generated by \link{\code{ctmodel}}), 
#' which can be used with \link{\code{ctFit}} and \link{\code{ctKalman}} functions.
#' @export
#'
#' @examples
#' data(AnomAuth) 
