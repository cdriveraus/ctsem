...
if(!kalman & !binomial) '
  ...
  ',if(!kalman & !binomial) paste0('Ypredcov_filt_chol = diag_matrix( rep_vector(1,nobsi) .* vecsqrt(diagonal(MANIFESTVAR',checkvarying('MANIFESTVAR','[subjecti]','[1]'),'[whichobs,whichobs])));'),'
