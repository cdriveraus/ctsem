...
Use `ctFit()` as the main fitting function; `ctStanFit()` is now an alias. For
model specification, the usual modern workflow is:
...
#' Return dynamic system parameters in matrix forms: ctContinuousPars()
